      ...
      <div className="p-0 space-y-6">
        ...
        <div className="space-y-6 max-w-5xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-8">
              <p className="text-xl font-bold text-black mb-2">Gemini Vision</p>
        ...
        <div className="grid grid-cols-5 gap-4 max-w-6xl">
          <div className="bg-black neo-brutal-shadow-sm p-6 text-center">
            <p className="text-3xl font-bold text-white">85-95%</p>
            <p className="text-sm text-white mt-2">Accuracy</p>
          </div>
          <div className="bg-black neo-brutal-shadow-sm p-6 text-center">
            <p className="text-3xl font-bold text-white">30-45s</p>
