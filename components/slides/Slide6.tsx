    ...
    <Slide>
      <div className="p-0 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-6xl">
          ...
          <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-6">
            <p className="text-3xl font-bold text-black mb-2">90+</p>
        ...
        <div className="space-y-4 max-w-5xl">
          <p className="text-2xl font-bold text-black">Core Technologies</p>
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-6">
              <p className="text-xl font-bold text-black mb-2">Multi-Strategy Extraction</p>
              <p className="text-sm text-gray-700">Tries 5 parsers, selects best result with confidence scoring</p>
            </div>
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-6">
              <p className="text-xl font-bold text-black mb-2">Vision OCR Fallback</p>
              <p className="text-sm text-gray-700">Gemini Vision for scanned/image-based PDFs</p>
            </div>
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-6">
              <p className="text-xl font-bold text-black mb-2">Duplicate Detection</p>
              <p className="text-sm text-gray-700">Levenshtein distance with 85% similarity threshold</p>
            </div>
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-6">
              <p className="text-xl font-bold text-black mb-2">Type-Safe Templates</p>
