        ...
        <div className="space-y-6 max-w-6xl">
          ...
          <div className="grid grid-cols-[1fr,auto,1fr] gap-4 items-center">
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-4 md:p-6">
              <p className="text-base md:text-xl font-bold text-black mb-2">Diverse Resume Formats</p>
          ...
          <div className="grid grid-cols-[1fr,auto,1fr] gap-4 items-center">
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-4 md:p-6">
              <p className="text-base md:text-xl font-bold text-black mb-2">AI API Rate Limits</p>
          ...
          <div className="grid grid-cols-[1fr,auto,1fr] gap-4 items-center">
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-4 md:p-6">
              <p className="text-base md:text-xl font-bold text-black mb-2">Memory Constraints</p>
          ...
          <div className="grid grid-cols-[1fr,auto,1fr] gap-4 items-center">
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-4 md:p-6">
              <p className="text-base md:text-xl font-bold text-black mb-2">Data Quality Issues</p>
          ...
          <div className="grid grid-cols-[1fr,auto,1fr] gap-4 items-center">
            <div className="bg-white neo-border-thin neo-brutal-shadow-sm p-4 md:p-6">
              <p className="text-base md:text-xl font-bold text-black mb-2">User Experience</p>
