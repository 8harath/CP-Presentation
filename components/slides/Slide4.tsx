      ...
      <div className="p-0 space-y-4 md:space-y-6">
        ...
        <div className="flex flex-col items-center space-y-6 max-w-4xl mx-auto">
          ...
          <div className="bg-green-500 neo-border-thin neo-brutal-shadow px-12 py-6 w-full">
            <p className="text-lg md:text-2xl font-bold text-white text-center mb-4">Processing Pipeline</p>
          ...
          <div className="bg-orange-500 neo-border-thin neo-brutal-shadow px-12 py-6 w-full">
            <p className="text-lg md:text-2xl font-bold text-white text-center mb-4">External Services</p>
